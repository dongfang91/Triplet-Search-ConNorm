...
def main(query_path,documents_path,file_name,array_output,cui_path):
    ...
    # cui_path = "/xdisk/bethard/mig2020/extra/dongfangxu9/resources/umls/processed/cui_snomed_rxnorm_all"
    # cui_path = "/xdisk/bethard/mig2020/extra/dongfangxu9/resources/n2c2/resource/train_cui"
    # cui_path = "/xdisk/bethard/mig2020/extra/dongfangxu9/resources/n2c2/resource/train+dev_cui"
    
    gold_label = read.read_from_json(cui_path)
    dev_pre = [[gold_label[int(item)] for item in row[::-1][:30]] for row in idx ]
